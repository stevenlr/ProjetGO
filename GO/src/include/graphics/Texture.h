 ...
 */
typedef enum {
	TEXTURE_PION_BLANC,//!< TEXTURE_PION_BLANC
	TEXTURE_PION_NOIR, //!< TEXTURE_PION_NOIR
	TEXTURE_PLATEAU_9, //!< TEXTURE_PLATEAU_9
	TEXTURE_PLATEAU_13,//!< TEXTURE_PLATEAU_13
	TEXTURE_PLATEAU_19,//!< TEXTURE_PLATEAU_19
	TEXTURE_AURA,      //!< TEXTURE_AURA
